        ...
        <section id="iphone-section" className="bg-white">
            <div id="iphone-section" className="container mx-auto md:pt-24 lg:pt-12 relative h-fit">
                ...
                <div className="relative py-12">
                    <h2 ref={titleRef} className="text-3xl md:text-7xl font-bold text-black font-inter text-center max-w-[640px] px-8 mx-auto">AirPods Pro 3</h2>
                ...
                {/* Video Here */}
                <VideoPlayerGsap 
                    src={"https://www.apple.com/105/media/us/home/2025/fddcb96f-3455-4785-9873-42f96cabe984/anim/zoom/large_2x.mp4"} 
