...
export default function SVGBackgroundAnimation() {
    return <>
        <div className='absolute bottom-0 left-0 w-[480px] block -z-10'>
        ...
        <div className='absolute bottom-0 right-48 h-[720px] block -z-10'>
        ...
        <div className='absolute top-0 right-0 h-[480px] block -z-10'>
